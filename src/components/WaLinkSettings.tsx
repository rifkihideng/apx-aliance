  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row">
        <input
          type="url"
          className="w-full rounded-xl border border-zinc-700/70 bg-zinc-950/60 px-3.5 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 outline-none transition-all duration-200 hover:border-zinc-600/70 focus:border-emerald-400/80 focus:bg-zinc-950 focus:ring-4 focus:ring-emerald-500/10"
          value={link}
